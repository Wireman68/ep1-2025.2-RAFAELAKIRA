...
public class RegistroEventos
{
    ...
    public static void resetBancoDeDados()
    {
                    ...
                    .forEach(path ->
                            {
                                ...
                                {
                                    System.out.println("Erro: não foi possível deletar um dos com.akira.hospital.bancos:" + e.getMessage());
                                }
                            }
        ...
        {
            System.out.println("Erro limpando os com.akira.hospital.bancos:" + e.getMessage());
        }
    }
